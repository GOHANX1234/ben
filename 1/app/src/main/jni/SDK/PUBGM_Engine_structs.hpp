...
{
	class UAnimInstanceContainer*                      AnimInstanceContainer;                                    // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<class UAnimInstance*>                       FromInstance;                                             // 0x0004(0x000C) (ZeroConstructor)
};
...
struct FDecalBakingRequest
{
	...
	unsigned char                                      UnknownData01[0x8];                                       // 0x0008(0x0008) MISSED OFFSET
	TArray<struct FDecalParameter>                     DecalParams;                                              // 0x0010(0x000C) (ZeroConstructor, Transient)
	class UTextureRenderTarget2D*                      RenderTarget;                                             // 0x001C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UTexture*                                    OriginTexture;                                            // 0x0020(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
};
...
struct FRollbackNetStartupActorInfo
{
	...
	class ULevel*                                      Level;                                                    // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0034(0x0004) MISSED OFFSET
};
...
struct FObjectPoolConfig
{
	...
	struct FString                                     ExcludeLevelNames;                                        // 0x0038(0x000C) (Edit, ZeroConstructor)
	int                                                BackendSwitcherCBit;                                      // 0x0044(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      ClientSwitcher;                                           // 0x0048(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bPreCreateObject;                                         // 0x0049(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRecyclable;                                              // 0x004A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRecordTemplateParams;                                    // 0x004B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRecreateWhenRecycle;                                     // 0x004C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bReconstructWhenRecycle;                                  // 0x004D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bPreRegisterComps;                                        // 0x004E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bPreInitComps;                                            // 0x004F(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bPostInitComps;                                           // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bNeedAutoExpand;                                          // 0x0051(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableForChildClasses;                                   // 0x0052(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0053(0x0001) MISSED OFFSET
	struct FString                                     CustomPoolClass;                                          // 0x0054(0x000C) (Edit, ZeroConstructor)
};
...
{
	struct FName                                       ParameterName;                                            // 0x0000(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USparseVolumeTexture*                        ParameterValue;                                           // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FGuid                                       ExpressionGUID;                                           // 0x000C(0x0010) (IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
};
...
{
	unsigned char                                      UnknownData00[0x454];                                     // 0x0000(0x0454) MISSED OFFSET
	TArray<class UAnimInstance*>                       SubAnimInstances;                                         // 0x0454(0x000C) (ZeroConstructor, Transient)
};
...
{
	TEnumAsByte<EReferenceType>                        ReferenceType;                                            // 0x002A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x002B(0x0001) MISSED OFFSET
	class UClass*                                      DefaultLinkedInstance;                                    // 0x002C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x28];                                      // 0x0030(0x0028) UNKNOWN PROPERTY: SoftClassProperty Engine.AnimNode_SubInstanceContainer.DefaultSoftLinkedInstance
	struct FName                                       ContainerTag;                                             // 0x0058(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FPoseLink                                   SourcePose;                                               // 0x0060(0x000C) (Edit)
	bool                                               bResetChildOnActivation;                                  // 0x006C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bRequestBlendOnInstanceChanged;                           // 0x006D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x006E(0x0002) MISSED OFFSET
	float                                              BlendTime;                                                // 0x0070(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UAnimInstanceContainer*                      Container;                                                // 0x0074(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAnimInstance*                               ParentAnimInstance;                                       // 0x0078(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class UAnimInstance*                               InstanceToRun;                                            // 0x007C(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	class USkeletalMeshComponent*                      OwningSkeletalMesh;                                       // 0x0080(0x0004) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	TArray<class UProperty*>                           InstanceProperties;                                       // 0x0084(0x000C) (ZeroConstructor, Transient)
	TArray<class UProperty*>                           SubInstanceProperties;                                    // 0x0090(0x000C) (ZeroConstructor, Transient)
	TArray<struct FName>                               PropagatedPropertyNames;                                  // 0x009C(0x000C) (ZeroConstructor)
...
{
	unsigned char                                      UnknownData00[0x140];                                     // 0x0460(0x0140) MISSED OFFSET
};
...
struct FStaticMeshSourceModel
{
	...
	TArray<int>                                        FaceIndex2FragmentIndex;                                  // 0x03F4(0x000C) (ZeroConstructor)
	struct FString                                     SourceImportFilename;                                     // 0x0400(0x000C) (Edit, ZeroConstructor, EditConst)
};
