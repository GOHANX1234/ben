...
public:
	...
	unsigned char                                      bEnableTeamAI : 1;                                        // 0x0450(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0451(0x0003) MISSED OFFSET
	TArray<class UClass*>                              TeamAIClasses;                                            // 0x0454(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                SpawnerTeamID;                                            // 0x0460(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBotCategray>                          SpeciesCategory;                                          // 0x0464(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0465(0x0003) MISSED OFFSET
	int                                                SpawnerCampItemID;                                        // 0x0468(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                GroupID;                                                  // 0x046C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UActorComponent*>                     TeamAIComponents;                                         // 0x0470(0x000C) (ExportObject, ZeroConstructor)
...
public:
	...
	struct FMonsterParams                              CacheMobParams;                                           // 0x015C(0x0050)
	struct FFakePlayerParams                           CacheFPParams;                                            // 0x01AC(0x0010)
	struct FAIPlayerParams                             CacheAIPParams;                                           // 0x01BC(0x000C)
	struct FVehicleParams                              CacheVehicleParams;                                       // 0x01C8(0x0014)
	TMap<TEnumAsByte<EBotCategray>, int>               UnitsNumberThreshold;                                     // 0x01DC(0x0050) (ZeroConstructor)
...
{
public:
	float                                              QueryEnemyRange;                                          // 0x0168(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              QueryEnemyAngle;                                          // 0x016C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MinTimeLockTarget;                                        // 0x0170(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxRememberEnemySeconds;                                  // 0x0174(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PreciseHatredDecreaseSpeed;                               // 0x0178(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCorrectAfterTurnOver : 1;                                // 0x017C(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x017D(0x0003) MISSED OFFSET
	float                                              CorrectAfterTurnOverCD;                                   // 0x0180(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FollowSegmentTolerance;                                   // 0x0184(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 CurveThrottleInput;                                       // 0x0188(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinAngleWhenPivotSteering;                                // 0x018C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 CurveThrottleRateWhenTurning;                             // 0x0190(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 CurveSteeringInput;                                       // 0x0194(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseBrakeWhenTurning;                                     // 0x0198(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0199(0x0003) MISSED OFFSET
	float                                              MinRequiredSteeringChange;                                // 0x019C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinLengthRateAlmostReach;                                 // 0x01A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UCurveFloat*                                 CurveBrakeAlmostReach;                                    // 0x01A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SteeringThresholdUseBrake;                                // 0x01A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpeedThresholdUseBrake;                                   // 0x01AC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bBlockTest : 1;                                           // 0x01B0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData02[0x3];                                       // 0x01B1(0x0003) MISSED OFFSET
	float                                              BlockTestingTime;                                         // 0x01B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              BlockSpeedThresholdKMH;                                   // 0x01B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UClass*                                      DeadInventoryBoxTemplate;                                 // 0x01BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                DropID;                                                   // 0x01C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x01C4(0x0004) MISSED OFFSET
	struct FName                                       WrapperBoxName;                                           // 0x01C8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class APlayerTombBox*                              DeadTombBox;                                              // 0x01D0(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bDebug;                                                   // 0x01D4(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x01D5(0x0003) MISSED OFFSET
	int                                                DebugLevel;                                               // 0x01D8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              DebugInterval;                                            // 0x01DC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FString                                     BehaviorServiceDebugInfo;                                 // 0x01E0(0x000C) (BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData05[0x3C];                                      // 0x01EC(0x003C) MISSED OFFSET
	class ASTExtraVehicleBase*                         OwnerVehicle;                                             // 0x0228(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCacheMeshOnHit : 1;                                      // 0x022C(0x0001)
	unsigned char                                      UnknownData06[0x23];                                      // 0x022D(0x0023) MISSED OFFSET
...
{
public:
	struct FVector2D                                   AimDurationDeviation;                                     // 0x0250(0x0008) (Edit, IsPlainOldData)
	float                                              ShootTurretCD;                                            // 0x0258(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BulletExplosionRange;                                     // 0x025C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AimingLockRange;                                          // 0x0260(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              AimingLockRangeWhenFiring;                                // 0x0264(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   TurretAimRange;                                           // 0x0268(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	unsigned char                                      bPredictEnemyMove : 1;                                    // 0x0270(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0271(0x0003) MISSED OFFSET
	struct FVector2D                                   TurretShootRange;                                         // 0x0274(0x0008) (Edit, IsPlainOldData)
	unsigned char                                      bAimingConstantLerp : 1;                                  // 0x027C(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x027D(0x0003) MISSED OFFSET
	float                                              TurretAimingInterpConstantSpeed;                          // 0x0280(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TurretAimingInterpSpeed;                                  // 0x0284(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SimTurretAimingInterpConstantSpeed;                       // 0x0288(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TurretAimingErrorTolerance;                               // 0x028C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAlsoCheckArcLength : 1;                                  // 0x0290(0x0001) (Edit)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0291(0x0003) MISSED OFFSET
	float                                              ShootTargetLocationOffset;                                // 0x0294(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bTraceBlockShootTargetLocation : 1;                       // 0x0298(0x0001) (Edit)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0299(0x0003) MISSED OFFSET
	int                                                MaxTraceBlockTryTimes;                                    // 0x029C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bResetTurretAfterDestroy : 1;                             // 0x02A0(0x0001) (Edit)
	unsigned char                                      bFailedAimingWhenTurretCollided : 1;                      // 0x02A0(0x0001) (Edit)
	unsigned char                                      UnknownData04[0x3];                                       // 0x02A1(0x0003) MISSED OFFSET
	TMap<float, float>                                 BaseHitRate;                                              // 0x02A4(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              ShootMGCD;                                                // 0x02E0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ShootMGDuration;                                          // 0x02E4(0x0008) (Edit, IsPlainOldData)
	float                                              ShootMGInterval;                                          // 0x02EC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   ShootUpDownRange;                                         // 0x02F0(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootLeftRightRange;                                      // 0x02F8(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootLeftRightRangeDistance;                              // 0x0300(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootTargetSpeedRange;                                    // 0x0308(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   ShootTargetDistanceRangeDueToSpeed;                       // 0x0310(0x0008) (Edit, IsPlainOldData)
	struct FVector2D                                   MGShootRange;                                             // 0x0318(0x0008) (Edit, IsPlainOldData)
	unsigned char                                      bShouldMissOnPurpose : 1;                                 // 0x0320(0x0001)
	unsigned char                                      bCacheUsingMG : 1;                                        // 0x0320(0x0001)
	unsigned char                                      bCacheUsingTurret : 1;                                    // 0x0320(0x0001)
...
{
public:
	unsigned char                                      UnknownData00[0x3C];                                      // 0x0150(0x003C) UNKNOWN PROPERTY: SetProperty AI.AIPerceptionChildPickUpComponent.ChildPickUpWrapperActors
...
public:
	...
	unsigned char                                      UnknownData01[0x8];                                       // 0x0184(0x0008) MISSED OFFSET
	bool                                               IsMovable;                                                // 0x018C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsCheckVisAngle;                                          // 0x018D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               IsFireSpreadingCalCenter;                                 // 0x018E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x10C0 (0x1210 - 0x0150)
class UAIStateInfoComponentBase : public UAIBasicStateInfoComponent
{
public:
	struct FAIStateInfoBaseMod                         CacheAIStateInfoBaseMod;                                  // 0x0150(0x03A8)
	struct FAIStateInfoBaseMod                         LastAIStateInfoBaseMod;                                   // 0x04F8(0x03A8)
	struct FDiffAIStateInfoBaseModGeneral              CacheDiffAIStateInfoBaseModGeneral;                       // 0x08A0(0x0508)
	struct FDiffAIStateInfoBaseMod                     CacheDiffAIStateInfoBaseMod;                              // 0x0DA8(0x0360)
	bool                                               IsTouchedPlayer;                                          // 0x1108(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x1109(0x0003) MISSED OFFSET
	uint32_t                                           FrameNo;                                                  // 0x110C(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x1110(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SkipFrameConfig;                                          // 0x1114(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SkipFrameConfigSecond;                                    // 0x1118(0x0004) (ZeroConstructor, IsPlainOldData)
	class AController*                                 OwnerController;                                          // 0x111C(0x0004) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x1120(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAIActingComponent*                          AIActingComp;                                             // 0x1124(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class APawn*                                       MyOwnerPawn;                                              // 0x1128(0x0004) (ZeroConstructor, IsPlainOldData)
	class ABattleRoyaleGameModeBase*                   MyGameMode;                                               // 0x112C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x38];                                      // 0x1130(0x0038) MISSED OFFSET
	TArray<struct FDamageSource>                       DamageSourcesInfoNew;                                     // 0x1168(0x000C) (ZeroConstructor)
	TMap<int, class APickUpWrapperActor*>              CacheAINearbyItem;                                        // 0x1174(0x0050) (ZeroConstructor)
	TArray<class ASTExtraBaseCharacter*>               CacheNearbyEnemies;                                       // 0x11B0(0x000C) (ZeroConstructor)
	struct FCacheNearbyItemState                       CacheNearbyItemState;                                     // 0x11BC(0x001C)
	class UMLAIControllerComponent*                    MyMLAIControllerComp;                                     // 0x11D8(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	uint32_t                                           CacheModeMapId;                                           // 0x11DC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x11E0(0x000C) MISSED OFFSET
	class UMLAISubSystem*                              MLAISubSystem;                                            // 0x11EC(0x0004) (ZeroConstructor, IsPlainOldData)
	class UMLAIUtilsBase*                              MLAIUtils;                                                // 0x11F0(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAIStateInfoDataAsset*                       AIStateInfoDataAsset;                                     // 0x11F4(0x0004) (ZeroConstructor, IsPlainOldData)
	class AAIWorldVolume*                              AIWorldVolume;                                            // 0x11F8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x14];                                      // 0x11FC(0x0014) MISSED OFFSET
...
// 0x07F0 (0x1A00 - 0x1210)
class UAIStateInfoComponentBRBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoBRBase                          CacheAIStateInfoBRBase;                                   // 0x1210(0x01D0)
	struct FAIStateInfoBRBase                          LastAIStateInfoBRBase;                                    // 0x13E0(0x01D0)
	struct FDiffAIStateInfoBRBaseGeneral               CacheDiffAIStateInfoBRBaseGeneral;                        // 0x15B0(0x0260)
	struct FDiffAIStateInfoBRBase                      CacheDiffAIStateInfoBRBase;                               // 0x1810(0x01E0)
	class UMLAIUtilsBRBase*                            MLAIUtilsBR;                                              // 0x19F0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xC];                                       // 0x19F4(0x000C) MISSED OFFSET
...
// 0x01F0 (0x1400 - 0x1210)
class UAIStateInfoComponentMPBase : public UAIStateInfoComponentBase
{
public:
	struct FAIStateInfoMPBase                          CacheAIStateInfoMPBase;                                   // 0x1210(0x00A0)
	struct FAIStateInfoMPBase                          LastAIStateInfoMPBase;                                    // 0x12B0(0x00A0)
	struct FDiffAIStateInfoMPBaseGeneral               CacheDiffAIStateInfoMPBaseGeneral;                        // 0x1350(0x00B0)
...
// 0x00D8 (0x14D8 - 0x1400)
class UAIStateInfoComponentTeamDeath : public UAIStateInfoComponentMPBase
{
public:
	struct FAIStateInfoTeamDeath                       CacheAIStateInfoTeamDeath;                                // 0x1400(0x0048)
	struct FAIStateInfoTeamDeath                       LastAIStateInfoTeamDeath;                                 // 0x1448(0x0048)
	struct FDiffAIStateInfoTeamDeathGeneral            CacheDiffAIStateInfoTeamDeathGeneral;                     // 0x1490(0x0048)
...
public:
	...
	float                                              NearbyDynamicItemsVisibleAngle;                           // 0x01A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	float                                              NearbyDigLandScapeActorRange;                             // 0x01B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                NearbyDigLandScapeActorMaxNum;                            // 0x01B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIgnoreTreeAIWhenNoPlayerAround;                          // 0x01B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x01B9(0x0003) MISSED OFFSET
	float                                              IgnoreTreeAIRadius;                                       // 0x01BC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               UseBodyTPPCamera;                                         // 0x01C0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x01C1(0x0003) MISSED OFFSET
	TArray<int>                                        IgnoredMonsterIDs;                                        // 0x01C4(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<EAvatarSlotType>                            AvailableAvatarSlotTypes;                                 // 0x01D0(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
...
public:
	...
	class ABattleRoyaleGameMode*                       CurGameMode;                                              // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAIStateInfoBaseMod>       CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllMLAIInfoBaseModGeneral              CacheDiffAllPlayersInfoGeneral;                           // 0x00E0(0x00C8)
	struct FDiffAllMLAIInfoBaseMod                     CacheAllPlayersInfoCSS;                                   // 0x01A8(0x0090)
...
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0030(0x0038) MISSED OFFSET
	TMap<uint32_t, struct FAIBaseStateInfo>            CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBaseStateInfo>            CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerBaseInfoGeneral               CacheDiffAllPlayersInfoGeneral;                           // 0x00E0(0x00D8)
	struct FDiffAllPlayerBaseInfo                      CacheAllPlayersInfoCSS;                                   // 0x01B8(0x0350)
	struct FGlobalGameBaseState                        CacheGlobalGameState;                                     // 0x0508(0x0078)
	struct FGlobalGameBaseState                        LastGlobalGameState;                                      // 0x0580(0x0078)
	struct FDiffGlobalGameBaseState                    DiffGlobalGameState;                                      // 0x05F8(0x0068)
	struct FDiffGlobalGameBaseStateGeneral             DiffGlobalGameStateGeneral;                               // 0x0660(0x0098)
	TMap<uint32_t, uint32_t>                           DiffStateInfoKeyMap;                                      // 0x06F8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x34];                                      // 0x0734(0x0034) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0030(0x0038) MISSED OFFSET
	TMap<uint32_t, struct FAIBRBaseStateInfo>          CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIBRBaseStateInfo>          CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerBRBaseInfoGeneral             CacheDiffAllPlayersInfoGeneral;                           // 0x00E0(0x00C8)
	struct FDiffAllPlayerBRBaseInfo                    CacheAllPlayersInfoCSS;                                   // 0x01A8(0x0408)
	struct FGlobalGameBRBaseState                      CacheGlobalGameState;                                     // 0x05B0(0x00E0)
	struct FGlobalGameBRBaseState                      LastGlobalGameState;                                      // 0x0690(0x00E0)
	struct FDiffGlobalGameBRBaseState                  DiffGlobalGameState;                                      // 0x0770(0x0130)
	struct FDiffGlobalGameBRBaseStateGeneral           DiffGlobalGameStateGeneral;                               // 0x08A0(0x0148)
	unsigned char                                      UnknownData01[0x18];                                      // 0x09E8(0x0018) MISSED OFFSET
...
public:
	...
	bool                                               bCompareInXY;                                             // 0x0049(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0045(0x0003) MISSED OFFSET
	int                                                AcceptPlayerCount;                                        // 0x0048(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSavePawnCount : 1;                                       // 0x004C(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x004D(0x0003) MISSED OFFSET
	struct FBlackboardKeySelector                      nSavePawnCount;                                           // 0x0050(0x0020) (Edit, BlueprintVisible)
	struct FBlackboardKeySelector                      CenterLocationFromBBD;                                    // 0x0070(0x0020) (Edit, BlueprintVisible)
	struct FVector                                     TargetAnchorOffset;                                       // 0x0090(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
...
{
public:
	struct FBlackboardKeySelector                      BBKeyIsOutOfMaxDistance;                                  // 0x0048(0x0020) (Edit)
	struct FBlackboardKeySelector                      BBKeySpawnPoint;                                          // 0x0068(0x0020) (Edit)
	bool                                               bClearEnemyTargetWhenOutOfMaxDist;                        // 0x0088(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseAIMaxMoveDistanceVolume;                              // 0x0089(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bCheckZombieTeam;                                         // 0x0172(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bSelectEnemyInSafety;                                     // 0x0173(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bShowDebugInfo;                                           // 0x0174(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3];                                       // 0x0175(0x0003) MISSED OFFSET
	float                                              DebugInfoLife;                                            // 0x0178(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DebugRadius;                                              // 0x017C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bIsBornLandFindEnemy;                                     // 0x0180(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bUseVisibilityTrace;                                      // 0x0190(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bUseNewSetCurEnemy;                                       // 0x005C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	float                                              ModifyMoveSpeed;                                          // 0x0080(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCheckBlock : 1;                                          // 0x0084(0x0001) (Edit, BlueprintVisible)
	EBioVHMoveType                                     MoveType;                                                 // 0x0085(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFaceToTarget : 1;                                        // 0x0086(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0087(0x0001) MISSED OFFSET
	float                                              FaceToTargetToleranceAngle;                               // 0x0088(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxDurationStayStuck;                                     // 0x008C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              StuckSpeed;                                               // 0x0090(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0094(0x0004) MISSED OFFSET
	struct FBlackboardKeySelector                      BBKey_OutBlocked;                                         // 0x0098(0x0020) (Edit, BlueprintVisible)
	float                                              MaxExecutionDuration;                                     // 0x00B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class ABioVehicleBase*                             BioVH;                                                    // 0x00BC(0x0004) (ZeroConstructor, IsPlainOldData)
	class ABioVehicleAIController*                     BioVHAIC;                                                 // 0x00C0(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bUseNotTeamedWayPoints : 1;                               // 0x00A9(0x0001) (Edit)
...
{
public:
	bool                                               bDebugDraw;                                               // 0x0070(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0071(0x0003) MISSED OFFSET
	float                                              DebugDrawPointTime;                                       // 0x0074(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              FindPointRange;                                           // 0x0078(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x007C(0x0004) MISSED OFFSET
	struct FBlackboardKeySelector                      BBK_CurrentWayPoint;                                      // 0x0080(0x0020) (Edit)
	TArray<int>                                        SpecificIDList;                                           // 0x00A0(0x000C) (Edit, ZeroConstructor)
	EFindWayPointType                                  FindWayPointType;                                         // 0x00AC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUseNotTeamedWayPoints : 1;                               // 0x00AD(0x0001) (Edit)
...
{
public:
	struct FVector                                     SplineActorLocation;                                      // 0x0050(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FRotator                                    SplineActorRotation;                                      // 0x005C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	struct FBlackboardKeySelector                      BBKeySplineLocation;                                      // 0x0068(0x0020) (Edit, BlueprintVisible)
	struct FBlackboardKeySelector                      BBKeySplineActor;                                         // 0x0088(0x0020) (Edit, BlueprintVisible)
	float                                              ReachAcceptableDistance;                                  // 0x00A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FullPathDuration;                                         // 0x00AC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxFlyDuration;                                           // 0x00B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxProtectStationaryDuration;                             // 0x00B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bVelocityUpdateUseLerp;                                   // 0x00B8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x00B9(0x0003) MISSED OFFSET
	float                                              VelocityUpdateLerpSpeed;                                  // 0x00BC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bAutoFitSplineWithHorizonalCircle;                        // 0x00C0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x00C1(0x0003) MISSED OFFSET
	float                                              CircleRadius;                                             // 0x00C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                AutoFitFactor;                                            // 0x00C8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SplineCurveTangentLength;                                 // 0x00CC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              SplineCurveFirstTwoTangentLength;                         // 0x00D0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bStopWhenReadyToAttack;                                   // 0x00D4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00D5(0x0003) MISSED OFFSET
	float                                              ExecuteDurationAtLeast;                                   // 0x00D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   AttackDistRangeToTarget;                                  // 0x00DC(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bCompareInXY;                                             // 0x00E4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x00E5(0x0003) MISSED OFFSET
	struct FBlackboardKeySelector                      BBKeyTargetActor;                                         // 0x00E8(0x0020) (Edit, BlueprintVisible)
...
public:
	...
	unsigned char                                      bFilterOutBehaviorRegion : 1;                             // 0x0090(0x0001) (Edit)
...
public:
	...
	struct FVector2D                                   RandomAngle;                                              // 0x00A0(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	TArray<struct FVector2D>                           RandomAngleExtra;                                         // 0x00A8(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      bFilterBuilding : 1;                                      // 0x00B4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bFilterWater : 1;                                         // 0x00B4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bReachableTest : 1;                                       // 0x00B4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bFilterOutBehaviorRegion : 1;                             // 0x00B4(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bFindSpecialSurface : 1;                                  // 0x00B4(0x0001) (Edit, BlueprintVisible)
	TEnumAsByte<EPhysicalSurface>                      SurfaceType;                                              // 0x00B5(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUseNavmesh : 1;                                          // 0x00B6(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x1];                                       // 0x00B7(0x0001) MISSED OFFSET
	struct FName                                       SpecificNaVName;                                          // 0x00B8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bTraceBlock : 1;                                          // 0x00C0(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData02[0x3];                                       // 0x00C1(0x0003) MISSED OFFSET
	float                                              SweepCapsuleScale;                                        // 0x00C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	bool                                               bDrawDebug;                                               // 0x00A1(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FName                                       IgnoreOpen;                                               // 0x0088(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               UseFakePlayerAIControllerDoLandingSuccess;                // 0x0090(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	float                                              InnerRadiusDeltaValue;                                    // 0x0098(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              JumpRangeDistance;                                        // 0x009C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxTargetPositonDistance;                                 // 0x00A0(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxAttempt;                                               // 0x00A4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FString                                     CallLuaFuncName;                                          // 0x0064(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FString                                     Params;                                                   // 0x0070(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x007C(0x0004) MISSED OFFSET
...
{
public:
	class UClass*                                      AIActionExcutionCompClass;                                // 0x0150(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      AISoundCollectCompClass;                                  // 0x0154(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      AIStateInfoCompClass;                                     // 0x0158(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UClass*                                      MLAIParachuteJumpCompClass;                               // 0x015C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	class UAIActionExecutionComponent*                 AIActionExecutionComp;                                    // 0x0160(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIBasicStateInfoComponent*                  AIStateInfoComp;                                          // 0x0164(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAISoundCollectionComponent*                 AISoundCollectComp;                                       // 0x0168(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UMLAIParachuteJumpComponent*                 MLAIParachuteJumpComp;                                    // 0x016C(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UTeammateMLAIControllerComponent*            TeammateMLAIControllerComp;                               // 0x0170(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	float                                              HearRadius;                                               // 0x0174(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TMap<TEnumAsByte<ESTEPoseState>, struct FCameraViewPitchLimitData> CameraViewPitchLimitDataMap;                              // 0x0178(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FCameraViewPitchLimitData                   FreeFallCameraViewPitchLimitData;                         // 0x01B4(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FVector                                     PrePos;                                                   // 0x01BC(0x000C) (IsPlainOldData)
	float                                              PreTickTime;                                              // 0x01C8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x01CC(0x0004) MISSED OFFSET
	class AController*                                 OwnerController;                                          // 0x01D0(0x0004) (ZeroConstructor, IsPlainOldData)
	class ANewFakePlayerAIController*                  MyAIController;                                           // 0x01D4(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    MyPlayerController;                                       // 0x01D8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x14];                                      // 0x01DC(0x0014) MISSED OFFSET
	float                                              FindNavLocationRadius;                                    // 0x01F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxNavLocationFindTimes;                                  // 0x01F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLerpRotation;                                         // 0x01F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x01F9(0x0003) MISSED OFFSET
	float                                              LerpRotationThreshold;                                    // 0x01FC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsForceTargetRotation;                                    // 0x0200(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x0201(0x0003) MISSED OFFSET
	float                                              FirstLerpRotationDeltaTime;                               // 0x0204(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FreeCameraTurnVelocity;                                   // 0x0208(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              TurnVelocity;                                             // 0x020C(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FAIShootingPoseOffsetInfo                   shootingPoseOffsetInfo;                                   // 0x0210(0x0054) (Edit)
	float                                              AutoOpenDoorRange;                                        // 0x0264(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0268(0x0008) MISSED OFFSET
	bool                                               IsModifyDamageLuaOverride;                                // 0x0270(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x0271(0x0003) MISSED OFFSET
	float                                              RatingDamageScaleLuaOverride;                             // 0x0274(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bShouldSendVehicleInfo;                                   // 0x0278(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x1B];                                      // 0x0279(0x001B) MISSED OFFSET
	bool                                               IsChangeStatePC;                                          // 0x0294(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x3];                                       // 0x0295(0x0003) MISSED OFFSET
	uint32_t                                           AllyMasterID;                                             // 0x0298(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3A4];                                     // 0x029C(0x03A4) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0030(0x0038) MISSED OFFSET
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDynamicItemStateInfo>     CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerDynamicItemInfoGeneral        CacheDiffAllPlayersInfoGeneral;                           // 0x00E0(0x00C8)
	struct FDiffAllPlayerDynamicItemInfo               CacheAllPlayersInfoCSS;                                   // 0x01A8(0x0128)
	struct FGlobalDynamicItemState                     CacheGlobalGameState;                                     // 0x02D0(0x0038)
	struct FGlobalDynamicItemState                     LastGlobalGameState;                                      // 0x0308(0x0038)
	struct FDiffGlobalDynamicItemState                 DiffGlobalGameState;                                      // 0x0340(0x0060)
	struct FDiffGlobalDynamicItemStateGeneral          DiffGlobalGameStateGeneral;                               // 0x03A0(0x0060)
	TMap<uint64_t, struct FDynamicItem>                CacheDynamicItems;                                        // 0x0400(0x0050) (ZeroConstructor)
...
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0030(0x0038) MISSED OFFSET
	TMap<uint32_t, struct FAILandScapeDestroyInfo>     CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAILandScapeDestroyInfo>     CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerLandScapeDestroyInfo          CacheAllPlayersInfoCSS;                                   // 0x00E0(0x0090)
	struct FGlobalLandScapeChangeInfo                  CacheGlobalGameState;                                     // 0x0170(0x0020)
	struct FGlobalLandScapeChangeInfo                  LastGlobalGameState;                                      // 0x0190(0x0020)
	struct FDiffGlobalLandScapeChangeInfoGeneral       DiffGlobalGameStateGeneral;                               // 0x01B0(0x0048)
...
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0030(0x0038) MISSED OFFSET
	TMap<uint32_t, struct FAIDoorStateInfo>            CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIDoorStateInfo>            CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerDoorInfoGeneral               CacheDiffAllPlayersInfoGeneral;                           // 0x00E0(0x00C8)
	struct FDiffAllPlayerDoorInfo                      CacheAllPlayersInfoCSS;                                   // 0x01A8(0x0128)
	struct FGlobalDoorState                            CacheGlobalGameState;                                     // 0x02D0(0x0038)
	struct FGlobalDoorState                            LastGlobalGameState;                                      // 0x0308(0x0038)
	struct FDiffGlobalDoorState                        DiffGlobalGameState;                                      // 0x0340(0x0060)
	struct FDiffGlobalDoorStateGeneral                 DiffGlobalGameStateGeneral;                               // 0x03A0(0x0060)
	TMap<uint64_t, struct FDoorState>                  CacheDoorStates;                                          // 0x0400(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x043C(0x0004) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0030(0x0038) MISSED OFFSET
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyMonsterStateInfo>   CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerNearbyMonsterGeneral          CacheDiffAllPlayersInfoGeneral;                           // 0x00E0(0x00C8)
	struct FDiffAllPlayerNearbyMonsterInfo             CacheAllPlayersInfoCSS;                                   // 0x01A8(0x0128)
	struct FGlobalMonsterState                         CacheGlobalGameState;                                     // 0x02D0(0x0038)
	struct FGlobalMonsterState                         LastGlobalGameState;                                      // 0x0308(0x0038)
	struct FDiffGlobalMonsterState                     DiffGlobalGameState;                                      // 0x0340(0x0060)
	TMap<uint64_t, struct FMonsterState>               CacheMonsterStats;                                        // 0x03A0(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x03DC(0x0004) MISSED OFFSET
	struct FDiffGlobalMonsterStateGeneral              DiffGlobalGameStateGeneral;                               // 0x03E0(0x0060)
...
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0030(0x0038) MISSED OFFSET
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAINearbyPlayerStateInfo>    CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerNearbyPlayerInfoGeneral       CacheDiffAllPlayersInfoGeneral;                           // 0x00E0(0x00C8)
	struct FDiffAllPlayerNearbyPlayerInfo              CacheAllPlayersInfoCSS;                                   // 0x01A8(0x0090)
...
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0030(0x0038) MISSED OFFSET
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FMLAINearbyStateInfoBaseMod> CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllMLAINearbyInfoBaseModGeneral        CacheDiffAllPlayersInfoGeneral;                           // 0x00E0(0x00C8)
	struct FDiffAllMLAINearbyInfoBaseMod               CacheAllPlayersInfoCSS;                                   // 0x01A8(0x0148)
	struct FGlobalNearbyStateBaseMod                   CacheGlobalGameState;                                     // 0x02F0(0x0048)
	struct FGlobalNearbyStateBaseMod                   LastGlobalGameState;                                      // 0x0338(0x0048)
	struct FDiffGlobalNearbyStateBaseMod               DiffGlobalGameState;                                      // 0x0380(0x0070)
	struct FDiffGlobalNearbyStateBaseModGeneral        DiffGlobalGameStateGeneral;                               // 0x03F0(0x0090)
	TMap<uint64_t, struct FItemStateData>              CacheItemData;                                            // 0x0480(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FAINearbyThrown>             CacheAINearbyThrown;                                      // 0x04BC(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FObstacleState>              CacheObstacleStates;                                      // 0x04F8(0x0050) (ZeroConstructor)
...
public:
	...
	class ASTExtraPlayerController*                    OwnerPlayerController;                                    // 0x0178(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              FallingTime;                                              // 0x017C(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              CheckCountTime;                                           // 0x0180(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               bLandingInLowHeight;                                      // 0x0184(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0185(0x0003) MISSED OFFSET
	struct FVector                                     LastLocation;                                             // 0x0188(0x000C) (IsPlainOldData)
	bool                                               bDellJumpToLandExcute;                                    // 0x0194(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bNotiyParachuteComp;                                      // 0x0195(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x0196(0x0002) MISSED OFFSET
	struct FName                                       IgnoreOpen;                                               // 0x0198(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UMLAISubSystem*                              MLAISubSystem;                                            // 0x007C(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<struct FString, class UClass*>                CollectorNameToClassMap;                                  // 0x0080(0x0050) (ZeroConstructor)
	TMap<class ASTExtraPlayerCharacter*, bool>         CacheMLAIs;                                               // 0x00BC(0x0050) (ZeroConstructor)
	TMap<class ASTExtraPlayerCharacter*, bool>         CachePlayerAndBTAIs;                                      // 0x00F8(0x0050) (ZeroConstructor)
	TMap<uint32_t, bool>                               CacheCandidateAIs;                                        // 0x0134(0x0050) (ZeroConstructor)
	TMap<uint32_t, bool>                               AlreadySendDeadStateMap;                                  // 0x0170(0x0050) (ZeroConstructor)
	TMap<uint32_t, int>                                CachePlayerType;                                          // 0x01AC(0x0050) (ZeroConstructor)
	TMap<EDiffListIDTag, struct FDiffListIDMap>        DiffPlayerIDToListIDMap;                                  // 0x01E8(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FPropertyNameListIDMap>      DiffAIPlayerInfoListIDMaps;                               // 0x0224(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x18];                                      // 0x0260(0x0018) MISSED OFFSET
	class ABattleRoyaleGameMode*                       GameMode;                                                 // 0x0278(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0xC0];                                      // 0x00E4(0x00C0) MISSED OFFSET
	TMap<uint32_t, bool>                               AlreadySendDeadStateMap;                                  // 0x01A4(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x8];                                       // 0x01E0(0x0008) MISSED OFFSET
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x01E8(0x0030)
	float                                              AirAttackTotalTime;                                       // 0x0218(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAirAttackComponent*                         AirAttackComp;                                            // 0x021C(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FGlobalGameStateBRBase                      GlobalGameState;                                          // 0x0220(0x0140)
	struct FGlobalGameStateBRBase                      LastGlobalGameState;                                      // 0x0360(0x0140)
	class UMLAIUtilsBase*                              MLAIUtils;                                                // 0x04A0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x54];                                      // 0x04A4(0x0054) MISSED OFFSET
	TMap<uint32_t, int>                                CachePlayerRevivalTypes;                                  // 0x04F8(0x0050) (ZeroConstructor)
	class UMLAIStateInfoManager*                       MLAIStateInfoManager;                                     // 0x0534(0x0004) (ZeroConstructor, IsPlainOldData)
	TMap<uint32_t, struct FString>                     VoiceRoomInfoMap;                                         // 0x0538(0x0050) (ZeroConstructor)
	int                                                AirDropTag;                                               // 0x0574(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0578(0x0004) MISSED OFFSET
	float                                              ProduceSoundInterval;                                     // 0x057C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                nCanJumpToSky;                                            // 0x0580(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x3C];                                      // 0x0584(0x003C) UNKNOWN PROPERTY: SetProperty AI.MLAISubSystem.TeammateMLAITeamIDSet
	TArray<uint32_t>                                   SilentMLAIList;                                           // 0x05C0(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x8];                                       // 0x05CC(0x0008) MISSED OFFSET
	TMap<class AActor*, class ASpecialZoneActor*>      CacheSpecialZoneParents;                                  // 0x05D4(0x0050) (ZeroConstructor)
	TArray<class ASpecialZoneActor*>                   CacheDynamicSpecialZone;                                  // 0x0610(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x10];                                      // 0x061C(0x0010) MISSED OFFSET
	class ABattleRoyaleGameMode*                       CurGameMode;                                              // 0x062C(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FGlobalGameStateBaseMod                     CacheGlobalGameStateBaseMod;                              // 0x0128(0x00A8)
	struct FGlobalGameStateBaseMod                     LastGlobalGameStateBaseMod;                               // 0x01D0(0x00A8)
	struct FDiffGlobalGameStateBaseMod                 DiffGlobalGameStateBaseMod;                               // 0x0278(0x0068)
	struct FDiffGlobalGameStateBaseModGeneral          DiffGlobalGameStateBaseModGeneral;                        // 0x02E0(0x0110)
	struct FDiffListIDMap                              DiffPlayerIDToListIDMap;                                  // 0x03F0(0x003C)
	TMap<uint64_t, struct FPropertyNameListIDMap>      DiffAIPlayerInfoListIDMaps;                               // 0x042C(0x0050) (ZeroConstructor)
	TArray<struct FAIStateInfoBaseMod>                 CacheAllPlayersInfoBaseMod;                               // 0x0468(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x4];                                       // 0x0474(0x0004) MISSED OFFSET
	struct FDiffAllPlayerInfoBaseModGeneral            CacheDiffAllPlayersInfoBaseModGeneral;                    // 0x0478(0x0078)
	struct FDiffAllPlayerInfoBaseMod                   CacheAllPlayersInfoBaseModCSS;                            // 0x04F0(0x01A0)
	TMap<uint32_t, struct FAIStateInfoBaseMod>         LastAllPlayerInfoMapBaseMod;                              // 0x0690(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIStateInfoBaseMod>         CacheAllPlayersInfoMapBaseMod;                            // 0x06CC(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x60];                                      // 0x0708(0x0060) MISSED OFFSET
	TArray<class ASTExtraPlayerCharacter*>             CacheMLAIs;                                               // 0x0768(0x000C) (ZeroConstructor)
	TArray<class ASTExtraPlayerCharacter*>             CachePlayerAndBTAIs;                                      // 0x0774(0x000C) (ZeroConstructor)
	class ABattleRoyaleGameMode*                       CurGameMode;                                              // 0x0780(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAIActingComponent*                          AIActingComp;                                             // 0x0784(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UMLAISubSystem*                              MLAISubSystem;                                            // 0x0788(0x0004) (ZeroConstructor, IsPlainOldData)
...
// 0x0B20 (0x12B0 - 0x0790)
class UMLAIUtilsBRBase : public UMLAIUtilsBase
{
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0790(0x0038) MISSED OFFSET
	TMap<uint64_t, struct FVehicleState>               CacheVehicleStates;                                       // 0x07C8(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FDynamicItem>                CacheDynamicItems;                                        // 0x0804(0x0050) (ZeroConstructor)
	TMap<uint64_t, struct FMonsterState>               CacheMonsterStats;                                        // 0x0840(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x4];                                       // 0x087C(0x0004) MISSED OFFSET
	struct FGlobalGameStateBRBase                      CacheGlobalGameStateBRBase;                               // 0x0880(0x0140)
	struct FGlobalGameStateBRBase                      LastGlobalGameStateBRBase;                                // 0x09C0(0x0140)
	struct FDiffGlobalGameStateBRBase                  DiffGlobalGameStateBRBase;                                // 0x0B00(0x0130)
	struct FDiffGlobalGameStateBRBaseGeneral           DiffGlobalGameStateBRBaseGeneral;                         // 0x0C30(0x0260)
	struct FRedZoneState                               CacheRedZoneInfo;                                         // 0x0E90(0x0030)
	TArray<struct FAIStateInfoBRBase>                  CacheAllPlayersInfoBRBase;                                // 0x0EC0(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x4];                                       // 0x0ECC(0x0004) MISSED OFFSET
	struct FDiffAllPlayerInfoBRBaseGeneral             CacheDiffAllPlayersInfoBRBaseGeneral;                     // 0x0ED0(0x0078)
	struct FDiffAllPlayerInfoBRBase                    CacheAllPlayersInfoBRBaseCSS;                             // 0x0F48(0x02E8)
	TMap<uint32_t, struct FAIStateInfoBRBase>          LastAllPlayerInfoMapBRBase;                               // 0x1230(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x2C];                                      // 0x126C(0x002C) MISSED OFFSET
	class UCircleMgrComponent*                         CircleMgr;                                                // 0x1298(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData04[0x14];                                      // 0x129C(0x0014) MISSED OFFSET
...
// 0x01A8 (0x0938 - 0x0790)
class UMLAIUtilsMPBase : public UMLAIUtilsBase
{
public:
	struct FGlobalGameStateMPBase                      CacheGlobalGameStateMPBase;                               // 0x0790(0x0038)
	struct FGlobalGameStateMPBase                      LastGlobalGameStateMPBase;                                // 0x07C8(0x0038)
	struct FDiffGlobalGameStateMPBaseGeneral           DiffGlobalGameStateMPBaseGeneral;                         // 0x0800(0x0048)
	TArray<struct FAIStateInfoMPBase>                  CacheAllPlayersInfoMPBase;                                // 0x0848(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0854(0x0004) MISSED OFFSET
	struct FDiffAllPlayerInfoMPBaseGeneral             CacheDiffAllPlayersInfoMPBaseGeneral;                     // 0x0858(0x0078)
	TMap<uint32_t, struct FAIStateInfoMPBase>          LastAllPlayerInfoMapMPBase;                               // 0x08D0(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x2C];                                      // 0x090C(0x002C) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0030(0x0038) MISSED OFFSET
	TMap<uint32_t, struct FAIMPStateInfo>              CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIMPStateInfo>              CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerMPBaseInfoGeneral             CacheDiffAllPlayersInfoGeneral;                           // 0x00E0(0x00D8)
	struct FGlobalGameMPState                          CacheGlobalGameState;                                     // 0x01B8(0x0038)
	struct FGlobalGameMPState                          LastGlobalGameState;                                      // 0x01F0(0x0038)
	struct FGlobalGameMPState                          DiffGlobalGameState;                                      // 0x0228(0x0038)
	struct FDiffGlobalGameMPBaseStateGeneral           DiffGlobalGameStateGeneral;                               // 0x0260(0x0048)
...
public:
	...
	int                                                Type;                                                     // 0x0344(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsDynamic;                                                // 0x0348(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0349(0x0003) MISSED OFFSET
	int                                                CustomState;                                              // 0x034C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsDestructibleMesh;                                       // 0x0350(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsInstanced;                                              // 0x0351(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0352(0x0002) MISSED OFFSET
	int                                                InstancedMaxNum;                                          // 0x0354(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TMap<struct FString, int>                          StaticMeshNameToType;                                     // 0x0358(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               CheckNearHaveAI;                                          // 0x0394(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0395(0x0003) MISSED OFFSET
	float                                              CheckAIDist;                                              // 0x0398(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USpecialZoneShapeComponent*                  SpecialZoneShapeComponent;                                // 0x039C(0x0004) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class AActor*                                      CacheParentActor;                                         // 0x03A0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x8];                                       // 0x03A4(0x0008) MISSED OFFSET
	class AAIWorldVolume*                              AIWorldVolume;                                            // 0x03AC(0x0004) (ZeroConstructor, IsPlainOldData)
	class UInstancedStaticMeshComponent*               CacheInstancedMeshComp;                                   // 0x03B0(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class USTDestructionComponent*                     CacheDestructibleMeshComp;                                // 0x03B4(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FString                                     DefaultLuaFilePath;                                       // 0x0150(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData00[0x4];                                       // 0x015C(0x0004) MISSED OFFSET
	struct FGameModeAIPlayerParams                     AIParams;                                                 // 0x0160(0x0358)
	uint32_t                                           AILevel;                                                  // 0x04B8(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           MLAIStyle;                                                // 0x04BC(0x0004) (ZeroConstructor, IsPlainOldData)
	uint32_t                                           TargetPlayerKey;                                          // 0x04C0(0x0004) (ZeroConstructor, IsPlainOldData)
	class ASTExtraPlayerController*                    OwnerPlayerController;                                    // 0x04C4(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              DefaultExitTime;                                          // 0x04C8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x04CC(0x0004) MISSED OFFSET
	struct FTimerHandle                                TeammateMLAIExitTimer;                                    // 0x04D0(0x0008)
	bool                                               bIsTakeOverTeammate;                                      // 0x04D8(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FAIVehicleStateData                         AIVehicleStateData;                                       // 0x0618(0x0078)
	class UAIBehaviorAdapter_VehicleBase*              AIBehaviorAdapter;                                        // 0x0690(0x0004) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	unsigned char                                      UnknownData00[0x38];                                      // 0x0030(0x0038) MISSED OFFSET
	TMap<uint32_t, struct FAIVehicleStateInfo>         CurrentAllPlayerStateInfoMap;                             // 0x0068(0x0050) (ZeroConstructor)
	TMap<uint32_t, struct FAIVehicleStateInfo>         CacheAllPlayersInfo;                                      // 0x00A4(0x0050) (ZeroConstructor)
	struct FDiffAllPlayerVehicleInfoGeneral            CacheDiffAllPlayersInfoGeneral;                           // 0x00E0(0x00C8)
	struct FDiffAllPlayerVehicleInfo                   CacheAllPlayersInfoCSS;                                   // 0x01A8(0x02A0)
	struct FGlobalVehicleState                         CacheGlobalGameState;                                     // 0x0448(0x0048)
	struct FGlobalVehicleState                         LastGlobalGameState;                                      // 0x0490(0x0048)
	struct FDiffGlobalVehicleState                     DiffGlobalGameState;                                      // 0x04D8(0x0060)
	struct FDiffGlobalVehicleStateGeneral              DiffGlobalGameStateGeneral;                               // 0x0538(0x0070)
	TMap<uint64_t, struct FVehicleState>               CacheVehicleStates;                                       // 0x05A8(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x2C];                                      // 0x05E4(0x002C) MISSED OFFSET
