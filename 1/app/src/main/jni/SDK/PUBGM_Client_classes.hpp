...
public:
	...
	struct FPlayerInfoData                             PlayerInfoData;                                           // 0x0028(0x00C0)
	struct FPlayerAvatarData                           PlayerAvatarData;                                         // 0x00E8(0x0010)
	TMap<int, struct FWeaponDIYData>                   WeaponDIYData;                                            // 0x00F8(0x0050) (ZeroConstructor)
	class UBattleUtils*                                OwningBattleUtils;                                        // 0x0134(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FGameModeAIPlayerParams                     CachedAIPlayerParams;                                     // 0x00B0(0x0358)
	struct FString                                     LuaFilePath;                                              // 0x0408(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData02[0x3C];                                      // 0x0414(0x003C) MISSED OFFSET
...
public:
	...
	struct FString                                     payChannel;                                               // 0x0038(0x000C) (ZeroConstructor, Config)
	struct FString                                     CentauriIdc;                                              // 0x0044(0x000C) (ZeroConstructor)
	struct FString                                     ZoneID;                                                   // 0x0050(0x000C) (ZeroConstructor)
	struct FString                                     goodsZoneID;                                              // 0x005C(0x000C) (ZeroConstructor)
	struct FString                                     offerID;                                                  // 0x0068(0x000C) (ZeroConstructor, Config)
	int                                                iAOSShop;                                                 // 0x0074(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	struct FString                                     offerID_H5;                                               // 0x0078(0x000C) (ZeroConstructor, Config)
	struct FString                                     payChannel_H5;                                            // 0x0084(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData01[0x44];                                      // 0x0090(0x0044) MISSED OFFSET
	struct FString                                     PAY_TYPE_UC;                                              // 0x00D4(0x000C) (ZeroConstructor)
	struct FString                                     PAY_TYPE_GOODS;                                           // 0x00E0(0x000C) (ZeroConstructor)
	struct FString                                     PAY_TYPE_SUBSCRIBE;                                       // 0x00EC(0x000C) (ZeroConstructor)
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x00F8(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1C];                                      // 0x00FC(0x001C) MISSED OFFSET
...
{
public:
	bool                                               bInitInGame;                                              // 0x0068(0x0001) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0069(0x0003) MISSED OFFSET
	TMap<int, unsigned char>                           SaveTypeMap;                                              // 0x006C(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	TMap<int, struct FUIElemLayoutDetail>              CachedLayoutDetailMap;                                    // 0x00A8(0x0050) (BlueprintVisible, ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0xAC];                                      // 0x00E4(0x00AC) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x001C(0x0008) MISSED OFFSET
	bool                                               bIsFlashEffect;                                           // 0x0024(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0025(0x0003) MISSED OFFSET
	struct FSlateBrush                                 SelectedImageOriginalSlateBrush;                          // 0x0028(0x0098) (BlueprintVisible)
	class UMaterialInterface*                          SelectedImageCircularFlashEffectMaterial;                 // 0x00C0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          SelectedImageSquareFlashEffectMaterial;                   // 0x00C4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class UImage>                       InvalidImage;                                             // 0x00C8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UImage>                       SelectedImage;                                            // 0x00D0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UBorder>                      Border_RealSize;                                          // 0x00D8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UWidget>                      ParentWidget;                                             // 0x00E0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UWidget>                      ExpandAssociatedWidget;                                   // 0x00E8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UWidgetSwitcher>              OptionalWidgetSwitcher;                                   // 0x00F0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
// 0x06C8 (0x0838 - 0x0170)
class UGameFrontendHUD : public UFrontendHUD
{
public:
	struct FScriptMulticastDelegate                    OnHandleWebviewActionDelegate;                            // 0x0170(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetTicketNotifyDelegate;                                // 0x017C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnHandleServerListDownload;                               // 0x0188(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnUIStatReport;                                           // 0x0194(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnCloudGMReceive;                                         // 0x01A0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnReportClientTool;                                       // 0x01AC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FString                                     CSVTableRelativeDir;                                      // 0x01B8(0x000C) (ZeroConstructor, Config)
	TMap<struct FString, struct FString>               GameStatusMap;                                            // 0x01C4(0x0050) (ZeroConstructor)
	bool                                               EnableTickLog;                                            // 0x0200(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x1];                                       // 0x0201(0x0001) MISSED OFFSET
	bool                                               bEnableReportMemory;                                      // 0x0202(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0xD];                                       // 0x0203(0x000D) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnDeleteFileNotifyEvent;                                  // 0x0210(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x4];                                       // 0x021C(0x0004) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnLoadODPaksBinFinishNotifyEvent;                         // 0x0220(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData03[0x14];                                      // 0x022C(0x0014) MISSED OFFSET
	class UVoiceSDKInterface*                          VoiceSDK;                                                 // 0x0240(0x0004) (ZeroConstructor, IsPlainOldData)
	class UBugReporter*                                GameBugReporter;                                          // 0x0244(0x0004) (ZeroConstructor, IsPlainOldData)
	class UGMLogShare*                                 LogShare;                                                 // 0x0248(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MaxUpdateRetryTimes;                                      // 0x024C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x8];                                       // 0x0250(0x0008) MISSED OFFSET
	class UGDolphinUpdater*                            GDolphin;                                                 // 0x0258(0x0004) (ZeroConstructor, IsPlainOldData)
	class UTranslator*                                 Translator;                                               // 0x025C(0x0004) (ZeroConstructor, IsPlainOldData)
	class UHttpWrapper*                                HttpWrapper;                                              // 0x0260(0x0004) (ZeroConstructor, IsPlainOldData)
	class UGCPufferDownloader*                         GPuffer;                                                  // 0x0264(0x0004) (ZeroConstructor, IsPlainOldData)
	class ULaggingReporter*                            LaggingReporter;                                          // 0x0268(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x4];                                       // 0x026C(0x0004) MISSED OFFSET
	class UAsyncTaskDownloader*                        DownloadTask;                                             // 0x0270(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x44];                                      // 0x0274(0x0044) MISSED OFFSET
	bool                                               bUseDolphinUpdateFirst;                                   // 0x02B8(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableUseDolphinUpdate;                                  // 0x02B9(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableUseCDNUpdate;                                      // 0x02BA(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseDolphinUpdateAfterCDNFailed;                          // 0x02BB(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseCDNUpdateAfterDolphinFailed;                          // 0x02BC(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableEditorPufferDownload;                              // 0x02BD(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bIsWaitingUpdateStateData;                                // 0x02BE(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUsingDolphinUpdate;                                     // 0x02BF(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUsingCDNUpdate;                                         // 0x02C0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x13];                                      // 0x02C1(0x0013) MISSED OFFSET
	class UCDNUpdate*                                  CDNUpdater;                                               // 0x02D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData08[0x1B];                                      // 0x02E5(0x001B) MISSED OFFSET
	TScriptInterface<class UClientNetInterface>        ClientNetInterface;                                       // 0x0300(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FName                                       UnrealNetworkStatus;                                      // 0x0308(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x10];                                      // 0x0310(0x0010) MISSED OFFSET
	float                                              UnrealNetworkConnectingTimer;                             // 0x0320(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData10[0xC];                                       // 0x0324(0x000C) MISSED OFFSET
	float                                              UnrealNetworkConnectingTime;                              // 0x0330(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              UnrealNetworkConnectingTimeAsan;                          // 0x0334(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bUseDynamicCreateLuaManager;                              // 0x0338(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0339(0x0003) MISSED OFFSET
	TArray<struct FString>                             PersistentLuaManager;                                     // 0x033C(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData12[0x4];                                       // 0x0348(0x0004) MISSED OFFSET
	bool                                               bPatchReInitSequence;                                     // 0x034C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	...
	class ULuaEventBridge*                             LuaEventBridgeInstace;                                    // 0x0354(0x0004) (ZeroConstructor, IsPlainOldData)
	class UBattleWindowMgrLuaUtils*                    LuaBattleWindowMgr;                                       // 0x0358(0x0004) (ZeroConstructor, IsPlainOldData)
	class ULuaBlueprintMgr*                            LuaBlueprintSysMgr;                                       // 0x035C(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData14[0x4];                                       // 0x0360(0x0004) MISSED OFFSET
	struct FString                                     ScriptBPRelativeDir;                                      // 0x0364(0x000C) (ZeroConstructor, Config)
	struct FString                                     ScriptRelativeDir;                                        // 0x0370(0x000C) (ZeroConstructor, Config)
	struct FString                                     InGameLuaDir;                                             // 0x037C(0x000C) (ZeroConstructor, Config)
	struct FString                                     PreloadLuaFileRelativePath;                               // 0x0388(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             LuaDirList;                                               // 0x0394(0x000C) (ZeroConstructor, Config)
	TArray<struct FString>                             NoGCPackage;                                              // 0x03A0(0x000C) (ZeroConstructor, Config)
	float                                              LuaTickTime;                                              // 0x03AC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCallLuaTick;                                             // 0x03B0(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAutoLoginEnable;                                         // 0x03B1(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData15[0x22];                                      // 0x03B2(0x0022) MISSED OFFSET
	int                                                PingFirstReportIntervalSecond;                            // 0x03D4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PingReportIntervalSecond;                                 // 0x03D8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                LossSyncIntervalSecond;                                   // 0x03DC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                PlayerStatusReportIntervalSecond;                         // 0x03E0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                LossArraySyncIntervalSecond;                              // 0x03E4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData16[0x4];                                       // 0x03E8(0x0004) MISSED OFFSET
	int                                                vmInstrumentOptimization;                                 // 0x03EC(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UTssManager*                                 TssMgr;                                                   // 0x03F0(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData17[0x28];                                      // 0x03F4(0x0028) MISSED OFFSET
	float                                              PingReportInterval;                                       // 0x041C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData18[0xD8];                                      // 0x0420(0x00D8) MISSED OFFSET
	int64_t                                            DeactivatedThreshold;                                     // 0x04F8(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	int64_t                                            TimePassThreshold;                                        // 0x0500(0x0008) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ImageDownloadClearDayCount;                               // 0x0508(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	struct FScriptMulticastDelegate                    UIStackChangeDelegate;                                    // 0x050C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    UIStackRecoverDelegate;                                   // 0x0518(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationUIEvent;                              // 0x0524(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFRefreshAdaptationExUIEvent;                            // 0x0530(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    EnterBattleStageDelegate;                                 // 0x053C(0x000C) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnAfterInitedDolphinDelegate;                             // 0x0548(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinVersionInfoDelegate;                             // 0x0554(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinNoticeInstallApkDelegate;                        // 0x0560(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinProgressDelegate;                                // 0x056C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnDolphinErrorDelegate;                                   // 0x0578(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRepairOverMaxTimesDelegate;                             // 0x0584(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnUpdateFinishedDelegate;                                 // 0x0590(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnRestartGameDelegate;                                    // 0x059C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInitIMSDKEnvDelegate;                                   // 0x05A8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetEnableCDNGetVersionDelegate;                         // 0x05B4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAfterLoadedEditorLoginDelegate;                         // 0x05C0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnClearUIBeforeReInitLuaStateDelegate;                    // 0x05CC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnInitStateDelegate;                                      // 0x05D8(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnStartPufferUpdateDelegage;                              // 0x05E4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetUpdateStateCDNConfigUrlDelegate;                     // 0x05F0(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetCDNUpdateInfoDelegate;                               // 0x05FC(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnQuickLoginDelegate;                                     // 0x0608(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnGetRegionNoByCountryNoDelegate;                         // 0x0614(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnPhoneMailLoginCallbackDelegate;                         // 0x0620(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnLoginSDKCallbackDelegate;                               // 0x062C(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnFileModifiedDelegate;                                   // 0x0638(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData19[0x9C];                                      // 0x0644(0x009C) MISSED OFFSET
	class UImageDownloader*                            ImageDownloaderInGame;                                    // 0x06E0(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                FpsForWindowClient;                                       // 0x06E4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UUDPPingCollector*                           UDPPingCollector;                                         // 0x06E8(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               UIElemLayoutJsonConfigSwitch;                             // 0x06EC(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationAllSwitch;                                          // 0x06ED(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationBattleSwitch;                                       // 0x06EE(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               NationRankSwitch;                                         // 0x06EF(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               SelfieSwitch;                                             // 0x06F0(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               ReportBugSwitch;                                          // 0x06F1(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               FirstVoicePopupSwitch;                                    // 0x06F2(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRForbidVoiceSwitch;                                    // 0x06F3(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               GDPRSettingSwitch;                                        // 0x06F4(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData20[0x3];                                       // 0x06F5(0x0003) MISSED OFFSET
	int                                                GDPRUserType;                                             // 0x06F8(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bShouldShowAdaptTipInLobby;                               // 0x06FC(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData21[0x3];                                       // 0x06FD(0x0003) MISSED OFFSET
	float                                              fLaggingFPSDiffThreshold;                                 // 0x0700(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMin;                              // 0x0704(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFPSDiffThresholdMax;                              // 0x0708(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThreshold;                               // 0x070C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMin;                            // 0x0710(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fLaggingFrameTimeThresholdMax;                            // 0x0714(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              fFPSReportInterval;                                       // 0x0718(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData22[0x10];                                      // 0x071C(0x0010) MISSED OFFSET
	bool                                               bUnLoadNoGcPackage;                                       // 0x072C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData23[0x3];                                       // 0x072D(0x0003) MISSED OFFSET
	TArray<class UPackage*>                            NoGcPackages;                                             // 0x0730(0x000C) (ZeroConstructor)
	bool                                               bFlushAsyncLoadingBeforeGC;                               // 0x073C(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bEnableJMLog;                                             // 0x073D(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData24[0x86];                                      // 0x073E(0x0086) MISSED OFFSET
	bool                                               bEnableH5Cache;                                           // 0x07C4(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               bCheckWorldNameForLoadConfig;                             // 0x07C5(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData25[0x6];                                       // 0x07C6(0x0006) MISSED OFFSET
	class UColorBlindnessMgr*                          ColorBlindnessMgrInstace;                                 // 0x07CC(0x0004) (ZeroConstructor, IsPlainOldData)
	TArray<struct FNativeHUDTickContainer>             NativeHUDTickList;                                        // 0x07D0(0x000C) (ZeroConstructor)
	bool                                               IsNativeHUDTickLock;                                      // 0x07DC(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               IsShutDown;                                               // 0x07DD(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData26[0x2];                                       // 0x07DE(0x0002) MISSED OFFSET
	int                                                NativeHUDTickIndex;                                       // 0x07E0(0x0004) (ZeroConstructor, IsPlainOldData)
	class UAsyncLoadHelper*                            AsyncLoadHelper;                                          // 0x07E4(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     BattleUtilsClassName;                                     // 0x07E8(0x000C) (ZeroConstructor, Config)
	class UBattleUtils*                                BattleUtils;                                              // 0x07F4(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData27[0x8];                                       // 0x07F8(0x0008) MISSED OFFSET
	struct FScriptDelegate                             OnImagePickDetectEvent;                                   // 0x0800(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnPermissionResultEvent;                                  // 0x0810(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnDeviceRotationChangedEvent;                             // 0x0820(0x000C) (ZeroConstructor, InstancedReference)
	struct FString                                     CurrentMapName;                                           // 0x082C(0x000C) (ZeroConstructor)
...
public:
	...
	unsigned char                                      UnknownData01[0xAC];                                      // 0x008C(0x00AC) MISSED OFFSET
	bool                                               AllowIOSBGDownload;                                       // 0x0138(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               AllowIOSBGDownloadPush;                                   // 0x0139(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               DisableJPKRBGDownloadNightPush;                           // 0x013A(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x013B(0x0001) MISSED OFFSET
	int                                                DisableJPKRBGDownloadNightPushAfterHour;                  // 0x013C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                DisableJPKRBGDownloadNightPushBeforeHour;                 // 0x0140(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                IOSBGDownloadPushDelaySeconds;                            // 0x0144(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               EnableRandomBackupURL;                                    // 0x0148(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               EnablePufferUpdate;                                       // 0x0149(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	bool                                               UseLocalSrcVersionWhenUpdateFailed;                       // 0x014A(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData03[0x11];                                      // 0x014B(0x0011) MISSED OFFSET
	struct FString                                     UpdateInfoPath;                                           // 0x015C(0x000C) (ZeroConstructor, Config)
	bool                                               OpenDebugLog;                                             // 0x0168(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData04[0x14F];                                     // 0x0169(0x014F) MISSED OFFSET
...
public:
	...
	int                                                OptiHttpConfig_uEnableAverageShardingStrategy;            // 0x0314(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                OptiHttpConfig_uAverageShardingSize;                      // 0x0318(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                OptiHttpConfig_uEnableDynamicExpansionMaxTask;            // 0x031C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              PreFetchODPaks_StartTime;                                 // 0x0320(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     PreFetchODPaks_ConfigName;                                // 0x0324(0x000C) (ZeroConstructor)
...
{
public:
	TArray<struct FLobbyBgMatData>                     matWaitToChangeList;                                      // 0x0340(0x000C) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
...
public:
	...
	struct FString                                     PicturePath;                                              // 0x0348(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	struct FVector2D                                   RTSize;                                                   // 0x0354(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               AlphaFullCorrect;                                         // 0x035C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               AlphaReverse;                                             // 0x035D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x035E(0x0002) MISSED OFFSET
	float                                              AlphaRate;                                                // 0x0360(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               AlphaChannelEnable;                                       // 0x0364(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               GammaCorrect;                                             // 0x0365(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               HSSave;                                                   // 0x0366(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               ClearDrawRT;                                              // 0x0367(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInstance*                           WriteMat;                                                 // 0x0368(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UTextureRenderTarget2D*                      DrawRT;                                                   // 0x036C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneCaptureComponent2D*                    Capture2D;                                                // 0x0370(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class USceneCaptureComponent2D*                    AlphaCapture2D;                                           // 0x0374(0x0004) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	float                                              ScreenWidth;                                              // 0x0378(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ScreenHeight;                                             // 0x037C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   AABBBoxLeftPoint;                                         // 0x0380(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   AABBBoxRightPoint;                                        // 0x0388(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
...
{
public:
	class UGameBusinessManager*                        pManager;                                                 // 0x0348(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x034C(0x0002) MISSED OFFSET
	bool                                               bClearSourceCodeAfterInitialized;                         // 0x034E(0x0001) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x21];                                      // 0x034F(0x0021) MISSED OFFSET
...
{
public:
	int                                                MaskType;                                                 // 0x0210(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   MaskTransformPivot;                                       // 0x0214(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	struct FVector2D                                   MaskTransformScale;                                       // 0x021C(0x0008) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              MaskTransformAngle;                                       // 0x0224(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialInterface*                          MaskMaterial;                                             // 0x0228(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UTexture2D*                                  MaskTexture;                                              // 0x022C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UCustomLayoutProxy*                          CustomLayoutProxy;                                        // 0x00D8(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TMap<unsigned char, struct FString>                ReportSettingConfig;                                      // 0x00DC(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData01[0x3C];                                      // 0x0118(0x003C) MISSED OFFSET
	struct FString                                     CachedSaveGameName;                                       // 0x0154(0x000C) (ZeroConstructor, Config)
	TArray<struct FCustomSettingSaveGame>              CustomSettingSaveGames;                                   // 0x0160(0x000C) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x4];                                       // 0x016C(0x0004) MISSED OFFSET
	struct FScriptDelegate                             GetUserSettingsDelegate;                                  // 0x0170(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	class UEffectSettingMgr*                           EffectSettingMgrInstace;                                  // 0x0180(0x0004) (ZeroConstructor, IsPlainOldData)
	class USaveGame*                                   UserSettings;                                             // 0x0184(0x0004) (ZeroConstructor, IsPlainOldData)
	class USaveGame*                                   UserSettingsShadowData;                                   // 0x0188(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0xC];                                       // 0x018C(0x000C) MISSED OFFSET
	class UClass*                                      UserSettingsClass;                                        // 0x0198(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FString                                     UserSettingsClassName;                                    // 0x019C(0x000C) (ZeroConstructor, Config)
	struct FString                                     ActiveSaveGameName;                                       // 0x01A8(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData04[0x4];                                       // 0x01B4(0x0004) MISSED OFFSET
	struct FString                                     LanguageSettingsClassName;                                // 0x01B8(0x000C) (ZeroConstructor, Config)
	struct FString                                     LanguageSaveGameName;                                     // 0x01C4(0x000C) (ZeroConstructor, Config)
	unsigned char                                      UnknownData05[0x84];                                      // 0x01D0(0x0084) MISSED OFFSET
	TMap<struct FString, bool>                         LanguageMap;                                              // 0x0254(0x0050) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x4];                                       // 0x0290(0x0004) MISSED OFFSET
	class UClass*                                      SaveGameUIElemLayoutClass;                                // 0x0294(0x0004) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FScriptMulticastDelegate                    UDPPingShadowResultToLuaDelegate;                         // 0x00B4(0x000C) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0x40];                                      // 0x00C0(0x0040) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             OnRSTSSubtitleCallback;                                   // 0x0070(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0080(0x0010) MISSED OFFSET
	struct FString                                     ServerInfo;                                               // 0x0090(0x000C) (ZeroConstructor, Config)
	uint32_t                                           openVoiceSDKLog;                                          // 0x009C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           MicVolumeMUFactor;                                        // 0x00A0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           SpeekerVolumeMUFactor;                                    // 0x00A4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	int                                                RoomOperationTimeout;                                     // 0x00A8(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UGameFrontendHUD*                            GameFrontendHUD;                                          // 0x00AC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x78];                                      // 0x00B0(0x0078) MISSED OFFSET
	struct FScriptDelegate                             OpenMicFail;                                              // 0x0128(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenMicSuccess;                                           // 0x0138(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseMicFail;                                             // 0x0148(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseMicSuccess;                                          // 0x0158(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenSpeakerFail;                                          // 0x0168(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OpenSpeakerSuccess;                                       // 0x0178(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseSpeakerFail;                                         // 0x0188(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             CloseSpeakerSuccess;                                      // 0x0198(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinRoomFail;                                             // 0x01A8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinRoomNotify;                                           // 0x01B8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitRoomNotify;                                           // 0x01C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinLbsRoomNotify;                                        // 0x01D8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitLbsRoomNotify;                                        // 0x01E8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RoomStatusUpdatedNotify;                                  // 0x01F8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             SetAppInfoSuccess;                                        // 0x0208(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             SetAppInfoFail;                                           // 0x0218(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             GetReconnectInfo;                                         // 0x0228(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ImSpeakingNotify;                                         // 0x0238(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             TestMicFail;                                              // 0x0248(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             TestMicSuccess;                                           // 0x0258(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             QuitRoomFail;                                             // 0x0268(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             DownLoadFileNotify;                                       // 0x0278(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadFileNotify;                                         // 0x0288(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             KwsNotify;                                                // 0x0298(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ApplyMessageKeyNotify;                                    // 0x02A8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             MemberIsSpeakingNotify;                                   // 0x02B8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             LbsMemberIsSpeakingNotify;                                // 0x02C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnMuteSwitchResult;                                       // 0x02D8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ReportVoiceTimeToServer;                                  // 0x02E8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RecordSuccess;                                            // 0x02F8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RecordFail;                                               // 0x0308(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadSuccess;                                            // 0x0318(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             UploadFail;                                               // 0x0328(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             DownloadFileSuccess;                                      // 0x0338(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             DownloadFileFail;                                         // 0x0348(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             EnableRoomMicrophone;                                     // 0x0358(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             ExitInfectionGameMode;                                    // 0x0368(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             JoinInfectionGameMode;                                    // 0x0378(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             RequestPrivacyInSetting;                                  // 0x0388(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnReportPlayerCallback;                                   // 0x0398(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnVoiceSDKEvent;                                          // 0x03A8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             BeforeVoiceSDKInitDelegate;                               // 0x03B8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             AfterVoiceSDKInitDelegate;                                // 0x03C8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             AudioRouteChangedAfterSpeakerDelegate;                    // 0x03D8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             AudioSessionInterruptedDelegate;                          // 0x03E8(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             OnRoomMemeberInfoDelegate;                                // 0x03F8(0x0010) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData04[0x60];                                      // 0x0408(0x0060) MISSED OFFSET
	struct FScriptDelegate                             OnDeliverDataCallback;                                    // 0x0468(0x0010) (ZeroConstructor, InstancedReference)
...
public:
	unsigned char                                      UnknownData00[0xC];                                       // 0x001C(0x000C) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnWebSocketErrorEvent;                                    // 0x0028(0x000C) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnWebSocketMessageEvent;                                  // 0x0034(0x000C) (ZeroConstructor, InstancedReference)
