...
struct FBP_STRUCT_BTMode_type
{
	...
	bool                                               EnableTableInheritance_34_4B8CF280797C32C24FE2E9100D6EE175;// 0x00B0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x3];                                       // 0x00B1(0x0003) MISSED OFFSET
	int                                                BattleModeFightType_35_18B3C98059A09D7C0649045A09A6CC95;  // 0x00B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
